...
public record ApplicationError(String code, String message, String details) {
    ...
    /**
     * Forbidden error: authenticated user does not have enough permissions
     */
    public static ApplicationError forbidden(String resource, String reason) {
        return new ApplicationError("FORBIDDEN", "Forbidden access to %s".formatted(resource), reason);
    }
